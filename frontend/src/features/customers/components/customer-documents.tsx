...
import type { CustomerDocument } from "@/types/app";

export function CustomerDocuments({ documents }: { documents: CustomerDocument[] }) {
  return (
    <Card>
      <CardHeader>
        <div>
          <CardTitle>Documents</CardTitle>
          <CardDescription>Commercial contracts, tax certificates, and statements.</CardDescription>
        </div>
      </CardHeader>
